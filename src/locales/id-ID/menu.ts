export default {
  ...
  // =====Prime React=====
  'menu.prime-react': 'Reaksi Primer',
  'menu.prime-react.terminal': 'Terminal',
  'menu.prime-react.text-editor': 'Text Editor',
  'menu.prime-react.meter-group': 'Meter Group',
  // =====================

  // =====ANT DESIGN=====
  'menu.ant-design': 'Desain Semut',
  'menu.ant-design.progress': 'Progress',
  'menu.ant-design.pro-table': 'Tabel Pro',
  // =====================

  // =====PRO FLOW=====
  'menu.pro-flow': 'Aliran Pro',
  'menu.pro-flow.flow': 'Aliran',
  // =====================

  // =====REACT LEAFLET=====
  'menu.react-leaflet': 'Reaksi Selebaran',
  'menu.react-leaflet.maps': 'Peta',
  // =====================

  // =====GANTT TASK=====
  'menu.gantt-task': 'Tugas Gantt',
  // =====================
};
